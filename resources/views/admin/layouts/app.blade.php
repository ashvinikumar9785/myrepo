...
<head>
    ...
    <link href="{{url('public/admin/assets/libs/SnackBar-master/dist/snackbar.min.css')}}" rel="stylesheet">
    <link href="{{url('public/admin/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css')}}" rel="stylesheet"> 
    <link href="{{url('public/admin/assets/libs/dropify-master/dist/css/dropify.min.css')}}" rel="stylesheet">
    <link href="{{url('public/admin/assets/libs/select2/dist/css/select2.min.css')}}" rel="stylesheet">
    <link href="{{url('public/admin/assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}" rel="stylesheet">
    <link href="{{url('public/admin/dist/css/custom.css')}}" rel="stylesheet">
    @yield('styles')
...
<body>
    ...
    <!-- ============================================================== -->
    <div id="main-wrapper" data-sidebartype="{{(Auth::guard('admin')->user()->sidebar_style=='MINI')?'mini-sidebar':'full'}}" class="{{(Auth::guard('admin')->user()->sidebar_style=='MINI')?'mini-sidebar':''}}">
        <!-- ============================================================== -->
    ...
    <script src="{{url('public/admin/dist/js/form.js')}}"></script>
    <script src="{{url('public/admin/assets/libs/SnackBar-master/dist/snackbar.min.js')}}"></script>  
    <!--Wave Effects -->
    ...
    <script src="{{url('public/admin/assets/libs/dropify-master/dist/js/dropify.min.js')}}"></script>
