...
class SettingController extends Controller
{
    ...
    public function datatables()
    {
     ...
     public function appSetting(Request $request,$id=null){
                
            $title = "App Setting";
            $breadcrumbs = [
                ['name'=>'App Setting','relation'=>'link','url'=>route('app.setting')],
        ...
        if($request->ajax() && $request->isMethod('post')){
            try {
                $validator = Validator::make($request->all(), [
                    ...
                    'is_maintenance_message'           => 'required|max:255', 
                    'force_update_message'           => 'required|max:255', 
                    'app_store_url'           => 'required|max:255', 
                    'play_store_url'           => 'required|max:255', 
        ...
        return view('admin/settings/app-setting',compact('id','data','title','breadcrumbs'));
    }
}
